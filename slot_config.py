...
ZONE_CONFIG: dict = {
    ...
    # ── Row A (y: 5% – 28%) — largest row, widest lanes ───────────────────────
    "A1": {"coords": [0.02, 0.05, 0.23, 0.28], "capacity": 14},
    "A2": {"coords": [0.27, 0.05, 0.48, 0.28], "capacity": 12},
    "A3": {"coords": [0.52, 0.05, 0.73, 0.28], "capacity": 12},
    "A4": {"coords": [0.77, 0.05, 0.98, 0.28], "capacity": 10},

    # ── Row B (y: 38% – 62%) — middle row ─────────────────────────────────────
    "B1": {"coords": [0.02, 0.38, 0.23, 0.62], "capacity": 14},
    "B2": {"coords": [0.27, 0.38, 0.48, 0.62], "capacity": 12},
    "B3": {"coords": [0.52, 0.38, 0.73, 0.62], "capacity": 12},
    "B4": {"coords": [0.77, 0.38, 0.98, 0.62], "capacity": 10},

    # ── Row C (y: 72% – 95%) — bottom row ─────────────────────────────────────
    "C1": {"coords": [0.02, 0.72, 0.23, 0.95], "capacity": 14},
    "C2": {"coords": [0.27, 0.72, 0.48, 0.95], "capacity": 12},
    "C3": {"coords": [0.52, 0.72, 0.73, 0.95], "capacity": 12},
    "C4": {"coords": [0.77, 0.72, 0.98, 0.95], "capacity": 10},
}
